                ...
                <div class="col-lg-4 col-xlg-3 col-md-5">
                    <div class="card fixed-height">
                        ...
                        <div class="card-body"> <small class="text-muted">Email address </small>
                            <h6>{{$user->email}}<h6>{{$user->phone}}</h6> <small class="text-muted p-t-30 db">Address</small>
                                <h6>{{$user->address}}</h6>
                                <div class="map-box">
                                ...
                                <div class="card-body">
                                    <form class="form-horizontal form-material" method="post" action="{{ route('user.profile.update') }}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12">
                                                <input type="text" name="midname" Value ="{{$user->midname}}" class="form-control form-control-line">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="col-md-12 row">
                                            ...
                                            <div class="col-md-12">
                                                <input type="number" minlength="8" name="phone" value="{{$user->phone}}" class="form-control form-control-line" required>
                                            </div>
                                        </div>
                                        <div class="col-md-4 form-group">
                                            ...
                                            <div class=" col-md-4 form-group">
                                                ...
                                                <div class="col-md-12">
                                                    <input type="date" name="date_of_birth" value="{{$user->date_of_birth}}" class="form-control form-control-line" required>
                                                </div>
                                            </div>
                                    </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12">
                                                <textarea rows="5" name="about" class="form-control form-control-line" required>{{$user->about}}</textarea>
                                            </div>
                                        </div>
                                ...
                                <div class="card-body">
                                    <form class="form-horizontal form-material" method="post" action="{{ route('user.profile.update') }}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12">
                                                <input type="text" value="{{$user->address}}" name="address" class="form-control form-control-line" required>
                                            </div>
                                        </div>
                                        <div class="col-md-12 row">
                                        <div class="col-md-4 form-group">
                                            ...
                                            <div class="col-md-12">
                                                <input type="text" value="{{$user->city}}" class="form-control form-control-line" name="city">
                                            </div>
                                        </div>
                                        <div class="col-md-4 form-group">
                                            <label class="col-md-12">State</label>
                                            <div class="col-md-12">
                                                <input type="text" value="{{$user->state}}" class="form-control form-control-line" name="state">
                                            </div>
                                        </div>
                                        <div class="col-md-4 form-group">
                                            <label  class="col-md-12">Country</label>
                                            <div class="col-md-12">
                                                <input type="text" value="{{$user->country}}" class="form-control form-control-line" name="country">
                                            </div>
                                        </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12">
                                                <textarea rows="4"  class="form-control form-control-line" name="delivery_address" required>{{$user->delivery_address}}</textarea>
                                            </div>
                                        </div>
